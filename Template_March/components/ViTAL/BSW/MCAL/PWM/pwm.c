...
static ledc_channel_config_t ledc_channel[PWM_CHANNELS] = {
	{.channel = SERVO_MOTOR_1_PWM_CHANNEL,
	 .duty = 0,
	 .gpio_num = SERVO_MOTOR_1_PWM_PIN,
	...
	{.channel = BUZZER_PWM_CHANNEL,
	 ...
	 {.channel = SERVO_MOTOR_2_PWM_CHANNEL,
	 .duty = 0,
	 .gpio_num = SERVO_MOTOR_2_PWM_PIN,
	 .speed_mode = LEDC_LOW_SPEED_MODE,
	 .hpoint = 0,
	 .timer_sel = LEDC_TIMER_1},
	 
	 {.channel = SERVO_MOTOR_3_PWM_CHANNEL,
	 .duty = 0,
	 .gpio_num = SERVO_MOTOR_3_PWM_PIN,
	 .speed_mode = LEDC_LOW_SPEED_MODE,
	 .hpoint = 0,
	 .timer_sel = LEDC_TIMER_1},
	 
	 {.channel = SERVO_MOTOR_4_PWM_CHANNEL,
	 .duty = 0,
	 .gpio_num = SERVO_MOTOR_4_PWM_PIN,
	 .speed_mode = LEDC_LOW_SPEED_MODE,
	 .hpoint = 0,
	 .timer_sel = LEDC_TIMER_1},
	 
	 {.channel = SERVO_MOTOR_5_PWM_CHANNEL,
	 .duty = 0,
	 .gpio_num = SERVO_MOTOR_5_PWM_PIN,
	 .speed_mode = LEDC_LOW_SPEED_MODE,
	 .hpoint = 0,
	 .timer_sel = LEDC_TIMER_1},
	 
	 {.channel = SERVO_MOTOR_6_PWM_CHANNEL,
	 .duty = 0,
	 .gpio_num = SERVO_MOTOR_6_PWM_PIN,
	 .speed_mode = LEDC_LOW_SPEED_MODE,
	 .hpoint = 0,
	 .timer_sel = LEDC_TIMER_1}};
