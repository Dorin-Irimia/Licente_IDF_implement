...
{
	/* STEPPER_PIN */
	sg_gpio_config.pin_bit_mask = (uint32_t)LEFT_DIR_PIN_MASK;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)RIGHT_DIR_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_OUTPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)LEFT_COMAND_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_OUTPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)RIGHT_COMAND_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_OUTPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	/* COLOR_CHANGE_SENZOR*/
	sg_gpio_config.pin_bit_mask = (uint32_t)COLOR_S0_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_OUTPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)COLOR_S1_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_OUTPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)COLOR_S2_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_OUTPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)COLOR_S3_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_OUTPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)COLOR_OUTPUT_PIN_MASK;
	...
	/* LINE_sENSOR_HW */
	sg_gpio_config.pin_bit_mask = (uint32_t)LINE_LEFT_SENSOR_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_INPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)LINE_CENTER_SENSOR_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_INPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
	...
	sg_gpio_config.pin_bit_mask = (uint32_t)LINE_RIGHT_SENSOR_PIN_MASK;
	sg_gpio_config.mode = GPIO_MODE_INPUT;
	sg_gpio_config.pull_up_en = GPIO_PULLUP_DISABLE;
	sg_gpio_config.pull_down_en = GPIO_PULLDOWN_DISABLE;
	sg_gpio_config.intr_type = GPIO_INTR_DISABLE;
