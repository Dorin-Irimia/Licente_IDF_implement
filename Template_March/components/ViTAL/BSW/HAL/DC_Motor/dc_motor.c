...
void STEPMOT_vMove(bool bSTEPMotorLeft, bool bSTEPMotorRight)
{
	GPIO_vSetLevel(LEFT_DIR_PIN, LOW_LEVEL);
	GPIO_vSetLevel(RIGHT_DIR_PIN, LOW_LEVEL);
	GPIO_vSetLevel(LEFT_COMAND_PIN, bSTEPMotorLeft);
	GPIO_vSetLevel(RIGHT_COMAND_PIN, bSTEPMotorRight);
