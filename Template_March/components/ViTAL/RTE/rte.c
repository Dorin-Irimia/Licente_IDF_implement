...
{
    return g_POST_DataStructure.bButtonRun;
...
void RTE_vChangeAngle(uint32_t u32ServoAngle1,uint32_t u32ServoAngle2)
{
    SERVO_vChangeAngle(u32ServoAngle1,u32ServoAngle2);
}
